...
public class SensitiveBinaryComponent : TypedComponent
{
    private SensitiveBinaryComponent()
    {
        /* Reserved for deserialization */
    }

    public SensitiveBinaryComponent(string path, string format, string gitBlobSha1, string stableBinaryCorrelatingId = null)
    {
        this.Format = format;
