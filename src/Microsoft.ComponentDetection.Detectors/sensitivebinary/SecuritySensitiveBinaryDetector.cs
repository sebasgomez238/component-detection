namespace Microsoft.ComponentDetection.Detectors.SecuritySensitiveBinary;
...
/// </summary>
public class SecuritySensitiveBinaryDetector : FileComponentDetector, IExperimentalDetector
{
    ...
    protected override async Task OnFileFoundAsync(ProcessRequest processRequest, IDictionary<string, string> detectorArgs, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var component = new SensitiveBinaryComponent(relativePath, $"{format}", gitBlobSha1, stableBinaryCorrelatingId);
        ...
        {
            this.Logger.LogDebug("Skipping file locked by another process: {FilePath}", file.Location);
        }
        catch (Exception e)
        {
